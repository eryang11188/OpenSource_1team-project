...
우선 PR검사를 통과한 **merge된 6개의 main 파일들을 feature/combat 브랜치로 가져온 다음**, **github의 Pull Request검사를 통과하고, 원래의 combat 브랜치의 2개 파일들을 포함한 총 8개의 파일을 main으로 merge**하는 절차를 밟아 해결함.
(1. main의 파일 6개를 combat branch로 이동 -> 2. combat branch에서 PR검사 통과 -> 3. combat branch와 main을 merge)
